...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        for (const apt of appointments) {
            ...
            const requiredSlots = Math.ceil(apt.service.duration / 30) //para pegar quantas caixinhas de horário terá que ser preenchido.
            const startIndex = user.times.indexOf(apt.time) //para pegar o primeiro horário, e bloquear os seguintes a partir dele
